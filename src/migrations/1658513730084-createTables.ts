...
export class createTables1658513730084 implements MigrationInterface {
    name = 'createTables1658513730084'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isPaid" boolean NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "ticktsId" uuid, CONSTRAINT "REL_aeb5e5f9555f0f82743c2e5ce7" UNIQUE ("ticktsId"), CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
